...
export default {
    ...
    async fetch() {
      ...
      await axios.get('https://api.dev-cobra.de/v1/events/events', {headers: {"X-Integration-Name": "test", "X-Integration-Provider": "nuxt", "Content-Type": "application/json", "Authorization" : this.$auth.strategy.token.get()},
}).then(response => {
